...
import ProductBoxComplexSmall from "../../components/products/productBoxSimpleSmall/ProductBoxSimpleSmall";
        ...
        <div className={classes["special-products-container"] + " row"}>
          ...
          <div className={classes["block-1-products"] + " col-xxl-8"}>
            <div className={classes["block-1-products-div"] + " row"}>
              <div
                className={
                  classes["block-1-products-div-item"] + " col-xxl-4 col-sm-6"
                }
              >
