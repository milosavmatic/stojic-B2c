    ...
    <div className={classes["filters-holder"]}>
      ...
      <div className={classes["filters"]}>
        <Accordion defaultActiveKey="0">
          <Accordion.Item eventKey="0" className={classes["custom-accordion"]}>
          ...
          <Accordion.Item eventKey="1" className={classes["custom-accordion"]}>
            <Accordion.Header>
              <p>Tip</p>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="2" className={classes["custom-accordion"]}>
            <Accordion.Header>
              <p>Rezolucija boja</p>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="4" className={classes["custom-accordion"]}>
            <Accordion.Header>
              <p>Boja</p>
            </Accordion.Header>
            <Accordion.Body>
          ...
          <Accordion.Item eventKey="5" className={classes["custom-accordion"]}>
            <Accordion.Header>
              <p>Memorija</p>
            </Accordion.Header>
            <Accordion.Body>
